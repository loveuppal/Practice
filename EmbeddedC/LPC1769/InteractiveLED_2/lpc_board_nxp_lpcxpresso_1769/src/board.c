...
void Board_LED_Set(uint8_t LEDNumber, bool On)
{
	...
	if (LEDNumber == 0) {
			Chip_GPIO_WritePortBit(LPC_GPIO, LED_RED_GPIO_PORT_NUM, LED_RED_GPIO_BIT_NUM, On);
		}
	else if (LEDNumber == 1) {
				Chip_GPIO_WritePortBit(LPC_GPIO, LED_GREEN_GPIO_PORT_NUM, LED_GREEN_GPIO_BIT_NUM, On);
			}
	else if (LEDNumber == 2) {
				Chip_GPIO_WritePortBit(LPC_GPIO, LED_BLUE_GPIO_PORT_NUM, LED_BLUE_GPIO_BIT_NUM, On);
			}
}
